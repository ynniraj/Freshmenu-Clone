...
async function categoryData() {
    ...
    try {
        ...
        let response_buyOne = await fetch(`https://freshmenu-heroku.herokuapp.com/category/indian`);    //Filter by Area

        let response_rice = await fetch(`https://freshmenu-heroku.herokuapp.com/category/rice`);
        let response_noodles = await fetch(`https://freshmenu-heroku.herokuapp.com/category/noodle`);
        let response_pasta = await fetch(`https://freshmenu-heroku.herokuapp.com/category/pasta`);
        let response_biriyani = await fetch(`https://freshmenu-heroku.herokuapp.com/category/biryani`);
        let response_salad = await fetch(`https://freshmenu-heroku.herokuapp.com/category/salad`);
        let response_keto = await fetch(`https://freshmenu-heroku.herokuapp.com/category/chicken`);
        let response_burger = await fetch(`https://freshmenu-heroku.herokuapp.com/category/burger`);


        let response_breakfast = await fetch(`https://freshmenu-heroku.herokuapp.com/category/breakfast`);
        let response_snacks = await fetch(`https://freshmenu-heroku.herokuapp.com/category/starter`);


        let response_sandwitches = await fetch(`https://freshmenu-heroku.herokuapp.com/category/sandwich`);
        let response_sides = await fetch(`https://freshmenu-heroku.herokuapp.com/category/soup`);;
        let response_desserts = await fetch(`https://freshmenu-heroku.herokuapp.com/category/dessert`);
...
async function alsolike() {
    try {
        ...
        let res = await fetch(
            "https://freshmenu-heroku.herokuapp.com/category");
